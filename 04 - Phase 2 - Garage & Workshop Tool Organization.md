...
* **Mounting Style:** Dual-purpose: docks into captive stops on the Shop Air Filter Cart (`house-diy/garage/Shop Air Filter Cart.md`) for whole-shop MERV 14 air scrubbing, or hangs from an oversized **ASA dual-hook cleat bracket** when stored flat against the back wall.
* *Filament:* **Bambu ASA** (5 walls, 30% Gyroid).
